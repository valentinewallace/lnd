...
type ChannelUpdate_UpdateType int32

const (
	ChannelUpdate_ACTIVE_CHANNEL   ChannelUpdate_UpdateType = 0
	ChannelUpdate_INACTIVE_CHANNEL ChannelUpdate_UpdateType = 1
	ChannelUpdate_CLOSED_CHANNEL   ChannelUpdate_UpdateType = 2
)

var ChannelUpdate_UpdateType_name = map[int32]string{
	0: "ACTIVE_CHANNEL",
	1: "INACTIVE_CHANNEL",
	2: "CLOSED_CHANNEL",
}
var ChannelUpdate_UpdateType_value = map[string]int32{
	"ACTIVE_CHANNEL":   0,
	"INACTIVE_CHANNEL": 1,
	"CLOSED_CHANNEL":   2,
}

func (x ChannelUpdate_UpdateType) String() string {
	return proto.EnumName(ChannelUpdate_UpdateType_name, int32(x))
}
func (ChannelUpdate_UpdateType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{55, 0} }
...
func (m *ChannelSubscription) Reset()                    { *m = ChannelSubscription{} }
func (m *ChannelSubscription) String() string            { return proto.CompactTextString(m) }
func (*ChannelSubscription) ProtoMessage()               {}
func (*ChannelSubscription) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{54} }

type ChannelUpdate struct {
	// Types that are valid to be assigned to Channel:
	//	*ChannelUpdate_OpenChannel
	//	*ChannelUpdate_ClosedChannel
	Channel isChannelUpdate_Channel  `protobuf_oneof:"channel"`
	Type    ChannelUpdate_UpdateType `protobuf:"varint,3,opt,name=type,enum=lnrpc.ChannelUpdate_UpdateType" json:"type,omitempty"`
}
...
func (*ChannelUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{55} }

type isChannelUpdate_Channel interface{ isChannelUpdate_Channel() }

type ChannelUpdate_OpenChannel struct {
	OpenChannel *Channel `protobuf:"bytes,1,opt,name=open_channel,json=channel,oneof"`
}
type ChannelUpdate_ClosedChannel struct {
	ClosedChannel *ChannelCloseSummary `protobuf:"bytes,2,opt,name=closed_channel,oneof"`
}

func (*ChannelUpdate_OpenChannel) isChannelUpdate_Channel()   {}
func (*ChannelUpdate_ClosedChannel) isChannelUpdate_Channel() {}

func (m *ChannelUpdate) GetChannel() isChannelUpdate_Channel {
	if m != nil {
		return m.Channel
	}
	return nil
...
func (m *ChannelUpdate) GetOpenChannel() *Channel {
	if x, ok := m.GetChannel().(*ChannelUpdate_OpenChannel); ok {
		return x.OpenChannel
	}
	return nil
}

func (m *ChannelUpdate) GetClosedChannel() *ChannelCloseSummary {
	if x, ok := m.GetChannel().(*ChannelUpdate_ClosedChannel); ok {
		return x.ClosedChannel
	}
	return nil
}

func (m *ChannelUpdate) GetType() ChannelUpdate_UpdateType {
	if m != nil {
		return m.Type
	}
	return ChannelUpdate_ACTIVE_CHANNEL
}

// XXX_OneofFuncs is for the internal use of the proto package.
func (*ChannelUpdate) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ChannelUpdate_OneofMarshaler, _ChannelUpdate_OneofUnmarshaler, _ChannelUpdate_OneofSizer, []interface{}{
		(*ChannelUpdate_OpenChannel)(nil),
		(*ChannelUpdate_ClosedChannel)(nil),
	}
}

func _ChannelUpdate_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ChannelUpdate)
	// channel
	switch x := m.Channel.(type) {
	case *ChannelUpdate_OpenChannel:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.OpenChannel); err != nil {
			return err
		}
	case *ChannelUpdate_ClosedChannel:
		b.EncodeVarint(2<<3 | proto.WireBytes)
	...
	case nil:
	default:
		return fmt.Errorf("ChannelUpdate.Channel has unexpected type %T", x)
	}
	return nil
}

func _ChannelUpdate_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ChannelUpdate)
	switch tag {
	case 1: // channel.open_channel
		...
		msg := new(Channel)
		err := b.DecodeMessage(msg)
		m.Channel = &ChannelUpdate_OpenChannel{msg}
		return true, err
	case 2: // channel.closed_channel
		...
		err := b.DecodeMessage(msg)
		m.Channel = &ChannelUpdate_ClosedChannel{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ChannelUpdate_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ChannelUpdate)
	// channel
	switch x := m.Channel.(type) {
	case *ChannelUpdate_OpenChannel:
...
func init() {
	...
	proto.RegisterType((*ChannelSubscription)(nil), "lnrpc.ChannelSubscription")
	...
	proto.RegisterEnum("lnrpc.ChannelUpdate_UpdateType", ChannelUpdate_UpdateType_name, ChannelUpdate_UpdateType_value)
}
...
type LightningClient interface {
	...
	// * lncli: `subscribechannels`
	// SubscribeChannels creates a uni-directional stream from the server to the
	// client in which any updates relevant to the state of the channels are sent
	// over. Events include new active channels, inactive channels, and closed
	// channels.
	SubscribeChannels(ctx context.Context, in *ChannelSubscription, opts ...grpc.CallOption) (Lightning_SubscribeChannelsClient, error)
...
func (c *lightningClient) SubscribeChannels(ctx context.Context, in *ChannelSubscription, opts ...grpc.CallOption) (Lightning_SubscribeChannelsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Lightning_serviceDesc.Streams[1], c.cc, "/lnrpc.Lightning/SubscribeChannels", opts...)
	if err != nil {
		return nil, err
	}
	x := &lightningSubscribeChannelsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Lightning_SubscribeChannelsClient interface {
	Recv() (*ChannelUpdate, error)
	grpc.ClientStream
}

type lightningSubscribeChannelsClient struct {
	grpc.ClientStream
}

func (x *lightningSubscribeChannelsClient) Recv() (*ChannelUpdate, error) {
	m := new(ChannelUpdate)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type LightningServer interface {
	...
	// over. Events include new active channels, inactive channels, and closed
	// channels.
	SubscribeChannels(*ChannelSubscription, Lightning_SubscribeChannelsServer) error
	// * lncli: `closedchannels`
	// ClosedChannels returns a description of all the closed channels that
	// this node was a participant in.
...
func _Lightning_SubscribeChannels_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ChannelSubscription)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LightningServer).SubscribeChannels(m, &lightningSubscribeChannelsServer{stream})
}

type Lightning_SubscribeChannelsServer interface {
	Send(*ChannelUpdate) error
	grpc.ServerStream
}

type lightningSubscribeChannelsServer struct {
	grpc.ServerStream
}

func (x *lightningSubscribeChannelsServer) Send(m *ChannelUpdate) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _Lightning_SubscribeChannels_Handler,
			ServerStreams: true,
		},
		{
...
var fileDescriptor0 = []byte{
	// 6546 bytes of a gzipped FileDescriptorProto
	,
	...
	0x54, 0xa9, 0x0b, 0x03, 0x61, 0x2e, 0x34, 0x65, 0x89, 0x07, 0xc3, 0xd3, 0xb4, 0x53, 0xa3, 0x86,
	...
	,
	...
	0x41, 0x79, 0x88, 0x79, 0x36, 0x89, 0xfb, 0x4d, 0x07, 0x18, 0x0e, 0xeb, 0x71, 0x24, 0xaa, 0xe5,
	0x2a, 0xe4, 0x77, 0xc0, 0x79, 0xe1, 0x1d, 0xa8, 0x5c, 0xb4, 0x03, 0xaf, 0xc1, 0x3c, 0x75, 0x89,
	0xb2, 0x3a, 0x57, 0x18, 0x96, 0xac, 0x73, 0xbf, 0xed, 0x40, 0x13, 0x35, 0x47, 0xc8, 0x47, 0x87,
	0x51, 0x10, 0xa6, 0xec, 0x0e, 0xb0, 0x93, 0x69, 0x38, 0x08, 0xc2, 0x61, 0x2f, 0xfd, 0x30, 0x18,
	...
	0x7b, 0x41, 0x38, 0xe0, 0x1f, 0xd2, 0x9a, 0x2d, 0x79, 0x16, 0x76, 0xb7, 0x05, 0x4d, 0xf3, 0x3b,
	0xf7, 0x33, 0xd0, 0x3e, 0x40, 0xc5, 0x10, 0x06, 0xe1, 0x70, 0x5b, 0x48, 0x2f, 0x6a, 0xab, 0xc9,
	0xf4, 0xf8, 0x09, 0x9f, 0xc9, 0x7d, 0x94, 0x25, 0x14, 0x89, 0xd3, 0x28, 0x49, 0xe5, 0xba, 0xd0,
	0x6f, 0xf7, 0x9f, 0x1d, 0x58, 0xc6, 0x45, 0x7f, 0xcf, 0x0f, 0x67, 0x6a, 0xc5, 0x0f, 0xa0, 0x89,
	...
	0x1d, 0x41, 0x40, 0x3b, 0x51, 0x78, 0xc2, 0xae, 0x43, 0x33, 0xf1, 0xd3, 0xde, 0x84, 0xc7, 0xb4,
	0x6a, 0x24, 0x38, 0x73, 0x1e, 0x24, 0x7e, 0x7a, 0xc8, 0xe3, 0xbb, 0xb3, 0x94, 0x77, 0x3f, 0x0b,
	...
	,
	...
	,
}
